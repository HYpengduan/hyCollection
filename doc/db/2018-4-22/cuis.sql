...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-DAE6NT61524355593452', '1524355795060', '15000');
...
-- ----------------------------
-- Table structure for t_bill_imp
-- ----------------------------
DROP TABLE IF EXISTS `t_bill_imp`;
CREATE TABLE `t_bill_imp` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(18) NOT NULL COMMENT '用户id',
  `order_no` varchar(20) NOT NULL DEFAULT '' COMMENT '订单编号',
  `bill_no` varchar(20) NOT NULL DEFAULT '' COMMENT '账单编号',
  `promise_repayment_date` datetime NOT NULL COMMENT '约定还款时间',
  `actual_settle_date` datetime DEFAULT NULL COMMENT '实际结清时间',
  `cur_period` int(4) NOT NULL DEFAULT '1' COMMENT '本次期数',
  `periods` int(4) NOT NULL DEFAULT '1' COMMENT '总期数',
  `cur_repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '本期应还金额（本息和）',
  `repay_principle` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应还本金',
  `repay_interest` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应还利息',
  `receivable_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应实收金额',
  `wait_repay_principle` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '剩余还款本金',
  `wait_repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '剩余应还款金额',
  `already_repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '已还款金额',
  `derate_amount` decimal(10,2) DEFAULT '0.00' COMMENT '优惠券减免金额',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '插入人',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='还款计划接口表';

-- ----------------------------
-- Records of t_bill_imp
-- ----------------------------

-- ----------------------------
-- Table structure for t_case_collector_action
-- ----------------------------
DROP TABLE IF EXISTS `t_case_collector_action`;
CREATE TABLE `t_case_collector_action` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `case_id` decimal(20,0) NOT NULL,
  `brcode` varchar(6) DEFAULT NULL,
  `collector` varchar(50) DEFAULT NULL,
  `last_brcode` varchar(6) DEFAULT NULL,
  `last_collector` varchar(50) DEFAULT NULL,
  ...
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`),
  KEY `ix_case_collector_action_caseid` (`case_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_case_collector_action
-- ----------------------------

-- ----------------------------
-- Table structure for t_case_main
-- ----------------------------
DROP TABLE IF EXISTS `t_case_main`;
CREATE TABLE `t_case_main` (
  `case_id` varchar(50) NOT NULL COMMENT '案件号',
  `user_id` varchar(50) DEFAULT NULL COMMENT '客户号',
  `queue_id` varchar(20) DEFAULT NULL COMMENT '案件队列',
  `enter_queue_date` datetime DEFAULT NULL COMMENT '进入队列时间',
  `strategy_no` varchar(20) DEFAULT NULL COMMENT '策略号',
  `case_strength` varchar(10) DEFAULT NULL COMMENT '案件强度',
  `overdue_stage` varchar(10) DEFAULT NULL COMMENT '逾期阶段',
  `case_status` varchar(6) DEFAULT NULL COMMENT '案件状态 已处理、待处理',
  `is_un_promise` varchar(2) DEFAULT NULL COMMENT '是否食言食言',
  `col_state` varchar(6) DEFAULT NULL COMMENT '催收状态',
  `is_black_list` varchar(2) DEFAULT NULL COMMENT '是否黑名单 催不回，前端催收员标识',
  `black_list_date` datetime DEFAULT NULL COMMENT '进入黑名单时间',
  `hold_date` datetime DEFAULT NULL COMMENT '跟催日期',
  `last_col_date` datetime DEFAULT NULL COMMENT '最后一次催收时间',
  `organ_code` varchar(20) DEFAULT NULL COMMENT '催收机构',
  `group_code` varchar(20) DEFAULT NULL COMMENT '催收组',
  `col_person` varchar(20) DEFAULT NULL COMMENT '催收员',
  `divide_batch` varchar(50) DEFAULT NULL COMMENT '分案批次 日期+机构代码 ',
  `divide_date` datetime DEFAULT NULL COMMENT '分案日期',
  `entrust_date` datetime DEFAULT NULL COMMENT '委案到期日',
  `over_date` datetime DEFAULT NULL,
  `col_times` int(6) DEFAULT NULL COMMENT '催记次数  跟进次数',
  ...
  PRIMARY KEY (`case_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='[案件主表]';

-- ----------------------------
-- Records of t_case_main
-- ----------------------------

-- ----------------------------
-- Table structure for t_case_param
-- ----------------------------
DROP TABLE IF EXISTS `t_case_param`;
CREATE TABLE `t_case_param` (
  `case_no` varchar(50) NOT NULL,
  `user_id` varchar(50) NOT NULL COMMENT '客户号',
  `account_year` int(6) DEFAULT '1',
  `product_type` varchar(10) DEFAULT NULL COMMENT '产品类型',
  `overdue_day` int(6) DEFAULT NULL COMMENT '逾期天数',
  `overdue_all` decimal(11,2) DEFAULT NULL COMMENT '逾期金额  逾期总额=滞纳金+逾期金额（罚息）',
  `overdue_fine` decimal(11,2) DEFAULT NULL COMMENT '滞纳金',
  `overdue_amount` decimal(11,2) DEFAULT NULL,
  `repay_principle` decimal(11,2) DEFAULT NULL COMMENT '应还本金',
  `repay_interest` decimal(11,2) DEFAULT NULL COMMENT '应还利息',
  `overdue_period` varchar(10) DEFAULT NULL COMMENT '逾期期数',
  `create_date` datetime DEFAULT NULL,
  `create_by` varchar(20) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `update_by` varchar(20) DEFAULT NULL,
  `record_status` int(2) DEFAULT NULL,
  PRIMARY KEY (`case_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='案件参数表';

-- ----------------------------
-- Records of t_case_param
-- ----------------------------

-- ----------------------------
-- Table structure for t_case_queue_action
-- ----------------------------
DROP TABLE IF EXISTS `t_case_queue_action`;
CREATE TABLE `t_case_queue_action` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '物理主键',
  `case_id` decimal(20,0) NOT NULL COMMENT '案件号',
  `queue_id` varchar(10) NOT NULL COMMENT '当前队列',
  `last_queue_id` varchar(10) NOT NULL COMMENT '上一队列',
  ...
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`),
  KEY `ix_queue_action_caseid` (`case_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_case_queue_action
-- ----------------------------

-- ----------------------------
-- Table structure for t_case_seq
-- ----------------------------
DROP TABLE IF EXISTS `t_case_seq`;
CREATE TABLE `t_case_seq` (
...
CREATE TABLE `t_contact` (
  `tel_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '物理主键',
  `user_id` varchar(40) NOT NULL COMMENT '客户号',
  `name` varchar(50) DEFAULT NULL COMMENT '联系人姓名',
  `mobile` varchar(30) DEFAULT NULL COMMENT '联系人手机号',
  `type` char(4) DEFAULT NULL COMMENT '联系人类型 字典码后续定义',
  `is_valid` char(2) DEFAULT 'Y' COMMENT '是否有效 有效：Y 无效：N',
  `sys_type` char(5) DEFAULT 'BT' COMMENT '系统类型 批量：BT 手工：HAND',
...
-- ----------------------------
-- Table structure for t_contact_imp
-- ----------------------------
DROP TABLE IF EXISTS `t_contact_imp`;
CREATE TABLE `t_contact_imp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(18) NOT NULL COMMENT '用户id',
  `name` varchar(50) DEFAULT NULL COMMENT '联系人姓名',
  `mobile` varchar(16) DEFAULT NULL COMMENT '联系人手机号',
  `relationship` varchar(10) DEFAULT NULL COMMENT '与联系人的关系',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='联系人信息接口表';

-- ----------------------------
-- Records of t_contact_imp
-- ----------------------------
...
CREATE TABLE `t_customer` (
  ...
  `mobile` varchar(12) NOT NULL COMMENT '用户手机',
  `real_name` varchar(50) NOT NULL COMMENT '客户姓名',
  `id_no` varchar(18) NOT NULL COMMENT '身份证号码',
  `birth` date DEFAULT NULL COMMENT '生日',
  `gender` varchar(1) DEFAULT NULL COMMENT '性别',
  `id_address` varchar(50) DEFAULT NULL COMMENT '身份证地址',
  `industry` varchar(45) DEFAULT NULL COMMENT '工作行业 工作类型',
  `profession` varchar(45) DEFAULT NULL COMMENT '工作职业',
  `payoff_day` date DEFAULT NULL COMMENT '发薪日',
  `telephone` varchar(17) DEFAULT NULL COMMENT '公司电话号码',
  `company_name` varchar(100) DEFAULT NULL COMMENT '单位名称',
  `highest_degree` varchar(10) DEFAULT NULL COMMENT '教育程度(学历)最高学历',
  `marital_status` varchar(2) DEFAULT NULL COMMENT '婚姻情况',
  `home_addr` varchar(255) DEFAULT NULL COMMENT '家庭地址address[联系地址]',
  `company_addr` varchar(255) DEFAULT NULL COMMENT '单位地址',
  `create_date` datetime DEFAULT NULL,
  `create_by` varchar(20) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `update_by` varchar(20) DEFAULT NULL,
  `record_status` int(1) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
-- ----------------------------
-- Table structure for t_cust_imp
-- ----------------------------
DROP TABLE IF EXISTS `t_cust_imp`;
CREATE TABLE `t_cust_imp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(18) NOT NULL COMMENT '用户id',
  ...
  `birth` varchar(30) NOT NULL COMMENT '生日',
  `id_address` varchar(100) NOT NULL COMMENT '身份证详细地址',
  `living_address` varchar(100) NOT NULL COMMENT '居住详细地址',
  `marital_status` varchar(10) NOT NULL COMMENT '婚姻状况',
  `highest_degree` varchar(10) NOT NULL COMMENT '最高学历',
  `industry` varchar(45) NOT NULL COMMENT '行业',
  `profession` varchar(45) NOT NULL COMMENT '职业',
  `company` varchar(45) NOT NULL COMMENT '公司',
  `telephone` varchar(20) NOT NULL COMMENT '公司电话',
  `salary` varchar(20) NOT NULL COMMENT '薪资',
  `company_address` varchar(100) NOT NULL COMMENT '公司详细地址',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客户信息接口表';

-- ----------------------------
-- Records of t_cust_imp
-- ----------------------------

-- ----------------------------
-- Table structure for t_daily_paid_over
-- ----------------------------
DROP TABLE IF EXISTS `t_daily_paid_over`;
CREATE TABLE `t_daily_paid_over` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_no` varchar(18) NOT NULL COMMENT '订单号',
  `actual_settle_date` datetime NOT NULL COMMENT '实际结清时间',
  `repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '剩余应还款金额',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='每日结案清单';

-- ----------------------------
-- Records of t_daily_paid_over
-- ----------------------------

-- ----------------------------
-- Table structure for t_data_status
-- ----------------------------
DROP TABLE IF EXISTS `t_data_status`;
CREATE TABLE `t_data_status` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `import_time` varchar(36) NOT NULL COMMENT '导入日期',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '数据导入状态 0：未完成；1：完成',
  `load_num` int(11) NOT NULL DEFAULT '0' COMMENT '完成导入表数量',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='数据导入状态表';

-- ----------------------------
-- Records of t_data_status
-- ----------------------------

-- ----------------------------
-- Table structure for t_entrust_protocol
-- ----------------------------
DROP TABLE IF EXISTS `t_entrust_protocol`;
CREATE TABLE `t_entrust_protocol` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '委案协议表',
  `case_no` varchar(50) NOT NULL COMMENT '案件号',
  `organ_no` varchar(20) DEFAULT NULL COMMENT '机构号',
  `col_person` varchar(20) DEFAULT NULL COMMENT '催收员',
  `entrust_date` date DEFAULT NULL COMMENT '委案日期',
  `back_date` date DEFAULT NULL COMMENT '到期退案日',
  `entrust_amount` decimal(11,2) DEFAULT NULL COMMENT '委案金额',
  `performance_amount` decimal(11,2) DEFAULT NULL COMMENT '绩效金额',
  `repay_amount` decimal(11,2) DEFAULT NULL COMMENT '还款金额',
  `overdue_amount` decimal(11,2) DEFAULT NULL COMMENT '逾期金额',
  `overdue_stage` varchar(10) DEFAULT NULL COMMENT '逾期阶段',
  `enstrust_status` varchar(10) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `create_by` varchar(20) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `update_by` varchar(20) DEFAULT NULL,
  `record_status` int(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='委案协议表';

-- ----------------------------
-- Records of t_entrust_protocol
-- ----------------------------
...
CREATE TABLE `t_order` (
  `order_no` varchar(50) NOT NULL COMMENT '账号(申请编号)',
  `user_id` varchar(40) DEFAULT NULL COMMENT '客户号',
  `case_id` varchar(30) DEFAULT NULL COMMENT '案件号',
  `is_paid_over` int(1) DEFAULT NULL COMMENT '是否结清',
  `loan_count` int(11) DEFAULT NULL COMMENT '第几次贷款',
  `loan_time` datetime DEFAULT NULL COMMENT '贷款申请时间',
  `pay_time` datetime DEFAULT NULL COMMENT '放款时间',
  `real_name` varchar(50) DEFAULT NULL COMMENT '账户姓名',
  `bank_name` varchar(100) DEFAULT NULL COMMENT '开户行名称',
  `bank_amount` varchar(20) DEFAULT NULL COMMENT '银行卡号',
  `loan_amount` decimal(11,2) DEFAULT NULL COMMENT '借款金额，（贷款金额）贷款额度本金',
  `borrow_periods` varchar(2) DEFAULT NULL COMMENT '还款期限，（分期期数）',
  `wait_repay_amount` decimal(11,2) DEFAULT NULL COMMENT '本期剩余还款金额（欠款总额剩的）',
  `overdue_all` decimal(11,2) DEFAULT NULL COMMENT '逾期金额逾期总额=滞纳金+逾期金额（罚息）',
  `overdue_fine` decimal(11,2) DEFAULT NULL COMMENT '滞纳金',
  `overdue_amount` decimal(11,2) DEFAULT NULL COMMENT '逾期罚息',
  `overdue_days` int(6) DEFAULT NULL COMMENT '逾期天数',
  `repay_principle` decimal(11,2) DEFAULT NULL COMMENT '应还本金',
  `repay_interest` decimal(11,2) DEFAULT NULL COMMENT '应还利息',
  `product_type` varchar(6) DEFAULT NULL COMMENT '产品类型',
  `business_strip` varchar(6) DEFAULT NULL COMMENT '业务线',
  `overdue_times` int(6) DEFAULT NULL COMMENT '逾期期数',
  `variage_pay_amount` decimal(11,2) DEFAULT NULL COMMENT '每期还款额',
  `account_year` int(6) DEFAULT NULL COMMENT '账龄',
  `last_ repay_amount` decimal(11,2) DEFAULT NULL COMMENT '最近一次还款金额最新一次repay_amount',
  `last_ actual_recorded_time` datetime DEFAULT NULL COMMENT '最近一次还款日期最新一次actual_recorded_time',
  `settle_amount` decimal(11,2) DEFAULT NULL COMMENT '结清金额 多期考虑',
  `over_case_amount` decimal(11,2) DEFAULT NULL COMMENT '结案金额',
...
-- ----------------------------
-- Table structure for t_order_imp
-- ----------------------------
DROP TABLE IF EXISTS `t_order_imp`;
CREATE TABLE `t_order_imp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_no` varchar(20) NOT NULL COMMENT '订单号(申请编号)',
  `user_id` varchar(18) NOT NULL COMMENT '用户id',
  `real_name` varchar(36) NOT NULL DEFAULT '' COMMENT '真实姓名',
  `loan_count` tinyint(4) NOT NULL DEFAULT '0' COMMENT '借款次数',
  `loan_time` datetime NOT NULL COMMENT '‪借款申请时间',
  `pay_time` datetime NOT NULL COMMENT '放款时间',
  `bank_name` varchar(50) NOT NULL COMMENT '开户行名称',
  `bank_account` varchar(50) NOT NULL COMMENT '用户卡号',
  `loan_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '借款金额',
  `borrow_time` tinyint(4) NOT NULL DEFAULT '0' COMMENT '借款时长（天）',
  `borrow_periods` tinyint(4) NOT NULL DEFAULT '0' COMMENT '借款期数',
  `wait_repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '剩余还款金额',
  `overdue_all_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '逾期总额=滞纳金+逾期金额（罚息）',
  `overdue_fine` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '滞纳金',
  `overdue_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '逾期金额（罚息）',
  `overdue_days` int(10) NOT NULL DEFAULT '0' COMMENT '逾期天数',
  `repay_principle` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应还本金',
  `repay_interest` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应还利息',
  `receivable_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '应实收金额',
  `product_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '产品类型 0：单期；1：多期',
  `business` varchar(36) NOT NULL DEFAULT 'nyd' COMMENT '会员使用业务范围',
  `overdue_stage` varchar(36) NOT NULL COMMENT '逾期阶段M1,M2,M3',
  `period_repay_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '每期还款额（不算罚息）',
  `bill_age` int(11) NOT NULL DEFAULT '0' COMMENT '账龄（天）',
  `bill_promise_date` datetime NOT NULL COMMENT '账单日（）',
  `record_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单信息接口表';

-- ----------------------------
-- Records of t_order_imp
-- ----------------------------

-- ----------------------------
-- Table structure for t_paid_over_list
-- ----------------------------
DROP TABLE IF EXISTS `t_paid_over_list`;
CREATE TABLE `t_paid_over_list` (
  `order_no` varchar(20) NOT NULL COMMENT '订单号',
  `pay_amount` decimal(12,2) DEFAULT NULL COMMENT '还款金额',
  `settle_date` datetime DEFAULT NULL COMMENT '结清日期',
  PRIMARY KEY (`order_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='结清表';

-- ----------------------------
-- Records of t_paid_over_list
-- ----------------------------

-- ----------------------------
-- Table structure for t_repay_imp
-- ----------------------------
DROP TABLE IF EXISTS `t_repay_imp`;
CREATE TABLE `t_repay_imp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` varchar(18) DEFAULT '' COMMENT '用户id',
  `bill_no` char(36) NOT NULL COMMENT '账单编号',
  ...
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='还款记录接口表';

-- ----------------------------
-- Records of t_repay_imp
-- ----------------------------
...
INSERT INTO `t_sys_dept` VALUES ('101', '100', '1部门', '1', '马研', '15011112222', 'ry@qq.com', '0', 'admin', '2018-04-20 14:58:07', 'ry', '2018-03-01 00:00:00');
INSERT INTO `t_sys_dept` VALUES ('102', '100', '2部门', '2', '马市', '15011112223', 'ry@qq.com', '0', 'admin', '2018-04-20 14:58:14', 'ry', '2018-03-01 00:00:00');
INSERT INTO `t_sys_dept` VALUES ('103', '100', '3部门', '3', '马测', '15011112224', 'ry@qq.com', '0', 'admin', '2018-04-20 14:58:22', 'ry', '2018-03-01 00:00:00');
INSERT INTO `t_sys_dept` VALUES ('104', '100', '4部门', '4', '马财', '15011112225', 'ry@qq.com', '0', 'admin', '2018-04-22 08:08:53', 'admin', '2018-04-22 08:08:53');
INSERT INTO `t_sys_dept` VALUES ('105', '100', '5部门', '5', '马运', '15011112226', 'ry@qq.com', '0', 'admin', '2018-04-22 08:08:58', 'admin', '2018-04-22 08:08:58');
INSERT INTO `t_sys_dept` VALUES ('106', '101', '1部门一部', '1', '马一', '15011112227', 'ry@qq.com', '0', 'admin', '2018-04-20 14:58:59', 'ry', '2018-03-01 00:00:00');
INSERT INTO `t_sys_dept` VALUES ('107', '101', '1部门二部', '2', '马二', '15011112228', 'ry@qq.com', '0', 'admin', '2018-04-22 08:09:09', 'admin', '2018-04-22 08:09:09');
INSERT INTO `t_sys_dept` VALUES ('108', '102', '2部门一部', '1', '马一', '15011112229', 'ry@qq.com', '0', 'admin', '2018-04-20 14:59:09', 'ry', '2018-03-01 00:00:00');
INSERT INTO `t_sys_dept` VALUES ('109', '102', '2部门二部', '2', '马二', '15011112210', 'ry@qq.com', '0', 'admin', '2018-04-22 08:09:03', 'admin', '2018-04-22 08:09:03');
...
CREATE TABLE `t_sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
INSERT INTO `t_sys_logininfor` VALUES ('137', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 12:12:44');
INSERT INTO `t_sys_logininfor` VALUES ('138', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 14:57:36');
INSERT INTO `t_sys_logininfor` VALUES ('139', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '退出成功', '2018-04-20 15:02:42');
INSERT INTO `t_sys_logininfor` VALUES ('140', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:06:01');
INSERT INTO `t_sys_logininfor` VALUES ('141', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:09:47');
INSERT INTO `t_sys_logininfor` VALUES ('142', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '退出成功', '2018-04-20 15:12:35');
INSERT INTO `t_sys_logininfor` VALUES ('143', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:12:36');
INSERT INTO `t_sys_logininfor` VALUES ('144', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:13:55');
INSERT INTO `t_sys_logininfor` VALUES ('145', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '退出成功', '2018-04-20 15:22:33');
INSERT INTO `t_sys_logininfor` VALUES ('146', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:22:35');
INSERT INTO `t_sys_logininfor` VALUES ('147', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-20 15:22:55');
INSERT INTO `t_sys_logininfor` VALUES ('148', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-22 07:45:56');
INSERT INTO `t_sys_logininfor` VALUES ('149', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-22 07:59:31');
INSERT INTO `t_sys_logininfor` VALUES ('150', 'admin', '127.0.0.1', 'Chrome', 'Windows 10', '0', '登录成功', '2018-04-22 08:06:52');
...
CREATE TABLE `t_sys_menu` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1006 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';

-- ----------------------------
-- Records of t_sys_menu
-- ----------------------------
INSERT INTO `t_sys_menu` VALUES ('1', '系统管理', '0', '1', '#', 'M', '0', '', 'fa fa-gear', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '系统管理目录');
INSERT INTO `t_sys_menu` VALUES ('2', '系统监控', '0', '2', '#', 'M', '0', '', 'fa fa-video-camera', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '系统监控目录');
INSERT INTO `t_sys_menu` VALUES ('3', '系统工具', '0', '3', '#', 'M', '1', '', 'fa fa-bars', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '系统工具目录');
INSERT INTO `t_sys_menu` VALUES ('4', '人员管理及配置', '1', '1', '/system/user', 'C', '0', 'system:user:view', '#', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '用户管理菜单');
INSERT INTO `t_sys_menu` VALUES ('5', '角色权限管理', '1', '2', '/system/role', 'C', '0', 'system:role:view', '#', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '角色管理菜单');
INSERT INTO `t_sys_menu` VALUES ('6', '菜单管理', '1', '3', '/system/menu', 'C', '0', 'system:menu:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '菜单管理菜单');
INSERT INTO `t_sys_menu` VALUES ('7', '团队管理及配置', '1', '4', '/system/dept', 'C', '0', 'system:dept:view', '#', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '部门管理菜单');
INSERT INTO `t_sys_menu` VALUES ('8', '岗位管理', '1', '5', '/system/post', 'C', '0', 'system:post:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '岗位管理菜单');
INSERT INTO `t_sys_menu` VALUES ('9', '字典管理', '1', '6', '/system/dict', 'C', '0', 'system:dict:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '字典管理菜单');
INSERT INTO `t_sys_menu` VALUES ('10', '参数设置', '1', '7', '/system/config', 'C', '0', 'system:config:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '参数设置菜单');
INSERT INTO `t_sys_menu` VALUES ('11', '操作日志', '2', '1', '/monitor/operlog', 'C', '0', 'monitor:operlog:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '操作日志菜单');
INSERT INTO `t_sys_menu` VALUES ('12', '登录日志', '2', '2', '/monitor/logininfor', 'C', '0', 'monitor:logininfor:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '登录日志菜单');
INSERT INTO `t_sys_menu` VALUES ('13', '在线用户', '2', '3', '/monitor/online', 'C', '0', 'monitor:online:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '在线用户菜单');
INSERT INTO `t_sys_menu` VALUES ('14', '定时任务', '2', '4', '/monitor/job', 'C', '0', 'monitor:job:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '定时任务菜单');
INSERT INTO `t_sys_menu` VALUES ('15', '数据监控', '2', '5', '/monitor/data', 'C', '0', 'monitor:data:view', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '数据监控菜单');
INSERT INTO `t_sys_menu` VALUES ('16', '代码生成', '3', '1', '/tool/gen', 'C', '1', 'tool:gen:view', '#', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '代码生成菜单');
INSERT INTO `t_sys_menu` VALUES ('17', '用户查询', '4', '1', '#', 'F', '0', 'system:user:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('18', '用户新增', '4', '2', '#', 'F', '0', 'system:user:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('19', '用户修改', '4', '3', '#', 'F', '0', 'system:user:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('20', '用户删除', '4', '4', '#', 'F', '0', 'system:user:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('21', '用户保存', '4', '5', '#', 'F', '0', 'system:user:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('22', '批量删除', '4', '6', '#', 'F', '0', 'system:user:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('23', '重置密码', '4', '7', '#', 'F', '0', 'system:user:resetPwd', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('24', '角色查询', '5', '1', '#', 'F', '0', 'system:role:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('25', '角色新增', '5', '2', '#', 'F', '0', 'system:role:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('26', '角色修改', '5', '3', '#', 'F', '0', 'system:role:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('27', '角色删除', '5', '4', '#', 'F', '0', 'system:role:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('28', '角色保存', '5', '5', '#', 'F', '0', 'system:role:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('29', '批量删除', '5', '6', '#', 'F', '0', 'system:role:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('30', '菜单查询', '6', '1', '#', 'F', '0', 'system:menu:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('31', '菜单新增', '6', '2', '#', 'F', '0', 'system:menu:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('32', '菜单修改', '6', '3', '#', 'F', '0', 'system:menu:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('33', '菜单删除', '6', '4', '#', 'F', '0', 'system:menu:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('34', '菜单保存', '6', '5', '#', 'F', '0', 'system:menu:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('35', '部门查询', '7', '1', '#', 'F', '0', 'system:dept:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('36', '部门新增', '7', '2', '#', 'F', '0', 'system:dept:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('37', '部门修改', '7', '3', '#', 'F', '0', 'system:dept:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('38', '部门删除', '7', '4', '#', 'F', '0', 'system:dept:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('39', '部门保存', '7', '5', '#', 'F', '0', 'system:dept:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('40', '岗位查询', '8', '1', '#', 'F', '0', 'system:post:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('41', '岗位新增', '8', '2', '#', 'F', '0', 'system:post:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('42', '岗位修改', '8', '3', '#', 'F', '0', 'system:post:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('43', '岗位删除', '8', '4', '#', 'F', '0', 'system:post:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('44', '岗位保存', '8', '5', '#', 'F', '0', 'system:post:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('45', '批量删除', '8', '4', '#', 'F', '0', 'system:post:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('46', '字典查询', '9', '1', '#', 'F', '0', 'system:dict:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('47', '字典新增', '9', '2', '#', 'F', '0', 'system:dict:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('48', '字典修改', '9', '3', '#', 'F', '0', 'system:dict:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('49', '批量删除', '9', '4', '#', 'F', '0', 'system:dict:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('50', '字典保存', '9', '5', '#', 'F', '0', 'system:dict:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('51', '操作查询', '11', '1', '#', 'F', '0', 'monitor:operlog:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('52', '批量删除', '11', '2', '#', 'F', '0', 'monitor:operlog:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('53', '详细信息', '11', '3', '#', 'F', '0', 'monitor:operlog:detail', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('54', '登录查询', '12', '1', '#', 'F', '0', 'monitor:logininfor:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('55', '批量删除', '12', '2', '#', 'F', '0', 'monitor:logininfor:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('56', '在线查询', '13', '1', '#', 'F', '0', 'monitor:online:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('57', '批量强退', '13', '2', '#', 'F', '0', 'monitor:online:batchForceLogout', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('58', '单条强退', '13', '3', '#', 'F', '0', 'monitor:online:forceLogout', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('59', '任务查询', '14', '1', '#', 'F', '0', 'monitor:job:list', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('60', '任务新增', '14', '2', '#', 'F', '0', 'monitor:job:add', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('61', '任务修改', '14', '3', '#', 'F', '0', 'monitor:job:edit', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('62', '任务删除', '14', '4', '#', 'F', '0', 'monitor:job:remove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('63', '任务保存', '14', '5', '#', 'F', '0', 'monitor:job:save', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('64', '状态修改', '14', '6', '#', 'F', '0', 'monitor:job:changeStatus', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('65', '批量删除', '14', '7', '#', 'F', '0', 'monitor:job:batchRemove', '#', 'admin', '2018-04-20 15:17:11', 'ry', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('1001', '综合管理', '0', '2', '#', 'M', '0', '', 'fa fa-book', 'admin', '2018-04-20 15:17:11', 'admin', '2018-04-20 15:17:11', '');
INSERT INTO `t_sys_menu` VALUES ('1002', '综合查询', '1001', '1', '/commanage/query', 'C', '0', 'commanage:query:view', 'fa fa-address-card-o', 'admin', '2018-04-20 15:24:20', 'admin', '2018-04-20 15:24:20', '');
INSERT INTO `t_sys_menu` VALUES ('1003', '队列查询', '1001', '2', '/commanage/queue', 'C', '0', 'commanage:queue', '', 'admin', '2018-04-20 15:25:48', '', '2018-04-21 08:01:13', '');
INSERT INTO `t_sys_menu` VALUES ('1004', '历史数据查询', '1001', '3', '/commanage/history', 'C', '0', 'commanage:history:view', '', 'admin', '2018-04-20 15:26:37', '', '2018-04-21 08:01:18', '');
INSERT INTO `t_sys_menu` VALUES ('1005', '催收组管理', '1', '4', '/system/group/view', 'C', '0', 'system:group:view', '', 'admin', '2018-04-22 08:04:20', '', null, '');
...
CREATE TABLE `t_sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
INSERT INTO `t_sys_oper_log` VALUES ('140', '系统管理', '部门管理-修改部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.edit()', 'web', 'admin', '研发一部', '/system/dept/edit/101', '127.0.0.1', '{}', '0', null, '2018-04-20 12:13:48');
INSERT INTO `t_sys_oper_log` VALUES ('141', '系统管理', '角色管理-修改角色', 'com.hy.cuis.manager.system.role.controller.RoleController.edit()', 'web', 'admin', '研发一部', '/system/role/edit/1', '127.0.0.1', '{}', '0', null, '2018-04-20 15:00:21');
INSERT INTO `t_sys_oper_log` VALUES ('142', '系统管理', '角色管理-新增角色', 'com.hy.cuis.manager.system.role.controller.RoleController.add()', 'web', 'admin', '研发一部', '/system/role/add', '127.0.0.1', '{}', '0', null, '2018-04-20 15:00:30');
INSERT INTO `t_sys_oper_log` VALUES ('143', '系统管理', '角色管理-保存角色', 'com.hy.cuis.manager.system.role.controller.RoleController.save()', 'web', 'admin', '研发一部', '/system/role/save', '127.0.0.1', '{\"roleName\":[\"管理员1\"],\"roleKey\":[\"admin1\"],\"roleSort\":[\"1\"],\"status\":[\"0\"],\"remark\":[\"\"],\"menuIds\":[\"\"],\"parentId\":[\"1\"]}', '0', null, '2018-04-20 15:01:02');
INSERT INTO `t_sys_oper_log` VALUES ('144', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/0', '127.0.0.1', '{}', '0', null, '2018-04-20 15:11:41');
INSERT INTO `t_sys_oper_log` VALUES ('145', '系统管理', '菜单管理-保存菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.save()', 'web', 'admin', '1部门一部', '/system/menu/save', '127.0.0.1', '{\"parentId\":[\"\"],\"menuType\":[\"M\"],\"menuName\":[\"综合管理\"],\"url\":[\"\"],\"perms\":[\"\"],\"orderNum\":[\"2\"],\"icon\":[\"fa fa-book\"],\"visible\":[\"0\"]}', '0', null, '2018-04-20 15:12:19');
INSERT INTO `t_sys_oper_log` VALUES ('146', '系统管理', '角色管理-修改角色', 'com.hy.cuis.manager.system.role.controller.RoleController.edit()', 'web', 'admin', '1部门一部', '/system/role/edit/1', '127.0.0.1', '{}', '0', null, '2018-04-20 15:14:10');
INSERT INTO `t_sys_oper_log` VALUES ('147', '系统管理', '角色管理-保存角色', 'com.hy.cuis.manager.system.role.controller.RoleController.save()', 'web', 'admin', '1部门一部', '/system/role/save', '127.0.0.1', '{\"roleId\":[\"1\"],\"roleName\":[\"管理员\"],\"roleKey\":[\"admin\"],\"roleSort\":[\"1\"],\"status\":[\"0\"],\"remark\":[\"\"],\"menuIds\":[\"1,4,17,18,19,20,21,22,23,5,24,25,26,27,28,29,6,30,31,32,33,34,7,35,36,37,38,39,8,40,41,42,43,44,45,9,46,47,48,49,50,10,2,11,51,52,53,12,54,55,', '0', null, '2018-04-20 15:14:14');
INSERT INTO `t_sys_oper_log` VALUES ('148', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:17:56');
INSERT INTO `t_sys_oper_log` VALUES ('149', '系统管理', '菜单管理-修改菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.edit()', 'web', 'admin', '1部门一部', '/system/menu/edit/16', '127.0.0.1', '{}', '0', null, '2018-04-20 15:18:25');
INSERT INTO `t_sys_oper_log` VALUES ('150', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:18:35');
INSERT INTO `t_sys_oper_log` VALUES ('151', '系统管理', '菜单管理-修改菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.edit()', 'web', 'admin', '1部门一部', '/system/menu/edit/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:20:04');
INSERT INTO `t_sys_oper_log` VALUES ('152', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:20:09');
INSERT INTO `t_sys_oper_log` VALUES ('153', '系统管理', '菜单管理-保存菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.save()', 'web', 'admin', '1部门一部', '/system/menu/save', '127.0.0.1', '{\"parentId\":[\"1001\"],\"menuName\":[\"综合查询\"],\"url\":[\"/commanage/query\"],\"perms\":[\"commanage:query:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-address-card-o\"],\"visible\":[\"0\"]}', '0', null, '2018-04-20 15:21:57');
INSERT INTO `t_sys_oper_log` VALUES ('154', '系统管理', '角色管理-修改角色', 'com.hy.cuis.manager.system.role.controller.RoleController.edit()', 'web', 'admin', '1部门一部', '/system/role/edit/1', '127.0.0.1', '{}', '0', null, '2018-04-20 15:22:11');
INSERT INTO `t_sys_oper_log` VALUES ('155', '系统管理', '角色管理-保存角色', 'com.hy.cuis.manager.system.role.controller.RoleController.save()', 'web', 'admin', '1部门一部', '/system/role/save', '127.0.0.1', '{\"roleId\":[\"1\"],\"roleName\":[\"管理员\"],\"roleKey\":[\"admin\"],\"roleSort\":[\"1\"],\"status\":[\"0\"],\"remark\":[\"\"],\"menuIds\":[\"1,4,17,18,19,20,21,22,23,5,24,25,26,27,28,29,6,30,31,32,33,34,7,35,36,37,38,39,8,40,41,42,43,44,45,9,46,47,48,49,50,10,2,11,51,52,53,12,54,55,', '0', null, '2018-04-20 15:22:16');
INSERT INTO `t_sys_oper_log` VALUES ('156', '系统管理', '角色管理-修改角色', 'com.hy.cuis.manager.system.role.controller.RoleController.edit()', 'web', 'admin', '1部门一部', '/system/role/edit/1', '127.0.0.1', '{}', '0', null, '2018-04-20 15:23:05');
INSERT INTO `t_sys_oper_log` VALUES ('157', '系统管理', '角色管理-保存角色', 'com.hy.cuis.manager.system.role.controller.RoleController.save()', 'web', 'admin', '1部门一部', '/system/role/save', '127.0.0.1', '{\"roleId\":[\"1\"],\"roleName\":[\"管理员\"],\"roleKey\":[\"admin\"],\"roleSort\":[\"1\"],\"status\":[\"0\"],\"remark\":[\"\"],\"menuIds\":[\"1,4,17,18,19,20,21,22,23,5,24,25,26,27,28,29,6,30,31,32,33,34,7,35,36,37,38,39,8,40,41,42,43,44,45,9,46,47,48,49,50,10,2,11,51,52,53,12,54,55,', '0', null, '2018-04-20 15:23:18');
INSERT INTO `t_sys_oper_log` VALUES ('158', '系统管理', '菜单管理-修改菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.edit()', 'web', 'admin', '1部门一部', '/system/menu/edit/1002', '127.0.0.1', '{}', '0', null, '2018-04-20 15:24:17');
INSERT INTO `t_sys_oper_log` VALUES ('159', '系统管理', '菜单管理-保存菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.save()', 'web', 'admin', '1部门一部', '/system/menu/save', '127.0.0.1', '{\"menuId\":[\"1002\"],\"parentId\":[\"1001\"],\"menuType\":[\"C\"],\"menuName\":[\"综合查询\"],\"url\":[\"/commanage/query\"],\"perms\":[\"commanage:query:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-address-card-o\"],\"visible\":[\"0\"]}', '0', null, '2018-04-20 15:24:20');
INSERT INTO `t_sys_oper_log` VALUES ('160', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:24:55');
INSERT INTO `t_sys_oper_log` VALUES ('161', '系统管理', '菜单管理-保存菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.save()', 'web', 'admin', '1部门一部', '/system/menu/save', '127.0.0.1', '{\"parentId\":[\"1001\"],\"menuType\":[\"C\"],\"menuName\":[\"队列查询\"],\"url\":[\"/commanage/queue\"],\"perms\":[\"commanage:queue\"],\"orderNum\":[\"2\"],\"icon\":[\"\"],\"visible\":[\"0\"]}', '0', null, '2018-04-20 15:25:48');
INSERT INTO `t_sys_oper_log` VALUES ('162', '系统管理', '菜单管理-新增菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.add()', 'web', 'admin', '1部门一部', '/system/menu/add/1001', '127.0.0.1', '{}', '0', null, '2018-04-20 15:25:51');
INSERT INTO `t_sys_oper_log` VALUES ('163', '系统管理', '菜单管理-保存菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.save()', 'web', 'admin', '1部门一部', '/system/menu/save', '127.0.0.1', '{\"parentId\":[\"1001\"],\"menuType\":[\"C\"],\"menuName\":[\"历史数据查询\"],\"url\":[\"/commanage/history\"],\"perms\":[\"commanage:history:view\"],\"orderNum\":[\"3\"],\"icon\":[\"\"],\"visible\":[\"0\"]}', '0', null, '2018-04-20 15:26:37');
INSERT INTO `t_sys_oper_log` VALUES ('164', '系统管理', '菜单管理-删除菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.remove()', 'web', 'admin', '1部门一部', '/system/menu/remove/1000', '127.0.0.1', '{}', '0', null, '2018-04-20 15:29:25');
INSERT INTO `t_sys_oper_log` VALUES ('165', '系统管理', '角色管理-新增角色', 'com.hy.cuis.manager.system.role.controller.RoleController.add()', 'web', 'admin', '1部门一部', '/system/role/add', '127.0.0.1', '{}', '0', null, '2018-04-20 15:32:55');
INSERT INTO `t_sys_oper_log` VALUES ('166', '系统管理', '角色管理-新增角色', 'com.hy.cuis.manager.system.role.controller.RoleController.add()', 'web', 'admin', '1部门一部', '/system/role/add', '127.0.0.1', '{}', '0', null, '2018-04-20 15:32:59');
INSERT INTO `t_sys_oper_log` VALUES ('167', '系统管理', '用户管理-新增用户', 'com.hy.cuis.manager.system.user.controller.UserController.add()', 'web', 'admin', '1部门一部', '/system/user/add', '127.0.0.1', '{}', '0', null, '2018-04-20 15:36:50');
INSERT INTO `t_sys_oper_log` VALUES ('168', '系统管理', '部门管理-新增部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.add()', 'web', 'admin', '1部门一部', '/system/dept/add/106', '127.0.0.1', '{}', '0', null, '2018-04-20 15:37:53');
INSERT INTO `t_sys_oper_log` VALUES ('169', '系统管理', '菜单管理-修改菜单', 'com.hy.cuis.manager.system.menu.controller.MenuController.edit()', 'web', 'admin', '1部门一部', '/system/menu/edit/1002', '127.0.0.1', '{}', '0', null, '2018-04-22 07:46:53');
INSERT INTO `t_sys_oper_log` VALUES ('170', '系统管理', '角色管理-修改角色', 'com.hy.cuis.manager.system.role.controller.RoleController.edit()', 'web', 'admin', '1部门一部', '/system/role/edit/1', '127.0.0.1', '{}', '0', null, '2018-04-22 07:47:08');
INSERT INTO `t_sys_oper_log` VALUES ('171', '系统管理', '角色管理-保存角色', 'com.hy.cuis.manager.system.role.controller.RoleController.save()', 'web', 'admin', '1部门一部', '/system/role/save', '127.0.0.1', '{\"roleId\":[\"1\"],\"roleName\":[\"管理员\"],\"roleKey\":[\"admin\"],\"roleSort\":[\"1\"],\"status\":[\"0\"],\"remark\":[\"\"],\"menuIds\":[\"1,4,17,18,19,20,21,22,23,5,24,25,26,27,28,29,6,30,31,32,33,34,7,35,36,37,38,39,8,40,41,42,43,44,45,9,46,47,48,49,50,10,2,11,51,52,53,12,54,55,', '0', null, '2018-04-22 07:47:15');
INSERT INTO `t_sys_oper_log` VALUES ('172', '系统管理', '部门管理-新增部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.add()', 'web', 'admin', '1部门一部', '/system/dept/add/101', '127.0.0.1', '{}', '0', null, '2018-04-22 08:07:34');
INSERT INTO `t_sys_oper_log` VALUES ('173', '系统管理', '部门管理-修改部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.edit()', 'web', 'admin', '1部门一部', '/system/dept/edit/104', '127.0.0.1', '{}', '0', null, '2018-04-22 08:08:51');
INSERT INTO `t_sys_oper_log` VALUES ('174', '系统管理', '部门管理-保存部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.save()', 'web', 'admin', '1部门一部', '/system/dept/save', '127.0.0.1', '{\"deptId\":[\"104\"],\"parentId\":[\"100\"],\"deptName\":[\"4部门\"],\"leader\":[\"马财\"],\"phone\":[\"15011112225\"],\"orderNum\":[\"4\"],\"email\":[\"ry@qq.com\"],\"status\":[\"0\"]}', '0', null, '2018-04-22 08:08:54');
INSERT INTO `t_sys_oper_log` VALUES ('175', '系统管理', '部门管理-修改部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.edit()', 'web', 'admin', '1部门一部', '/system/dept/edit/105', '127.0.0.1', '{}', '0', null, '2018-04-22 08:08:56');
INSERT INTO `t_sys_oper_log` VALUES ('176', '系统管理', '部门管理-保存部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.save()', 'web', 'admin', '1部门一部', '/system/dept/save', '127.0.0.1', '{\"deptId\":[\"105\"],\"parentId\":[\"100\"],\"deptName\":[\"5部门\"],\"leader\":[\"马运\"],\"phone\":[\"15011112226\"],\"orderNum\":[\"5\"],\"email\":[\"ry@qq.com\"],\"status\":[\"0\"]}', '0', null, '2018-04-22 08:08:58');
INSERT INTO `t_sys_oper_log` VALUES ('177', '系统管理', '部门管理-修改部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.edit()', 'web', 'admin', '1部门一部', '/system/dept/edit/109', '127.0.0.1', '{}', '0', null, '2018-04-22 08:08:59');
INSERT INTO `t_sys_oper_log` VALUES ('178', '系统管理', '部门管理-保存部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.save()', 'web', 'admin', '1部门一部', '/system/dept/save', '127.0.0.1', '{\"deptId\":[\"109\"],\"parentId\":[\"102\"],\"deptName\":[\"2部门二部\"],\"leader\":[\"马二\"],\"phone\":[\"15011112210\"],\"orderNum\":[\"2\"],\"email\":[\"ry@qq.com\"],\"status\":[\"0\"]}', '0', null, '2018-04-22 08:09:03');
INSERT INTO `t_sys_oper_log` VALUES ('179', '系统管理', '部门管理-修改部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.edit()', 'web', 'admin', '1部门一部', '/system/dept/edit/107', '127.0.0.1', '{}', '0', null, '2018-04-22 08:09:05');
INSERT INTO `t_sys_oper_log` VALUES ('180', '系统管理', '部门管理-保存部门', 'com.hy.cuis.manager.system.dept.controller.DeptController.save()', 'web', 'admin', '1部门一部', '/system/dept/save', '127.0.0.1', '{\"deptId\":[\"107\"],\"parentId\":[\"101\"],\"deptName\":[\"1部门二部\"],\"leader\":[\"马二\"],\"phone\":[\"15011112228\"],\"orderNum\":[\"2\"],\"email\":[\"ry@qq.com\"],\"status\":[\"0\"]}', '0', null, '2018-04-22 08:09:09');
...
-- ----------------------------
INSERT INTO `t_sys_role` VALUES ('1', '管理员', '0', 'admin', '1', '0', 'admin', '2018-04-22 07:47:14', 'admin', '2018-04-22 08:04:54', '管理员');
INSERT INTO `t_sys_role` VALUES ('2', '普通角色', '1', 'common', '2', '0', 'admin', '2018-04-13 14:39:10', 'ry', '2018-03-01 00:00:00', '普通角色');
INSERT INTO `t_sys_role` VALUES ('100', '管理员1', '1', 'admin1', '1', '0', 'admin', '2018-04-20 15:01:02', '', '0000-00-00 00:00:00', '');
...
INSERT INTO `t_sys_role_menu` VALUES ('1', '1001');
INSERT INTO `t_sys_role_menu` VALUES ('1', '1002');
INSERT INTO `t_sys_role_menu` VALUES ('1', '1003');
INSERT INTO `t_sys_role_menu` VALUES ('1', '1004');
INSERT INTO `t_sys_role_menu` VALUES ('1', '1005');
...
CREATE TABLE `t_sys_user_online` (
  ...
  `start_timestsamp` datetime NOT NULL COMMENT 'session创建时间',
...
-- ----------------------------
INSERT INTO `t_sys_user_online` VALUES ('cb5744ca-8a9a-4504-9530-3fd1ecc71d2d', 'admin', '1部门一部', '127.0.0.1', 'Chrome', 'Windows 10', 'on_line', '2018-04-22 08:06:51', '2018-04-22 08:08:52', '1800000');
...
CREATE TABLE `t_user_info` (
  ...
  `user_type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '用户类型，1为内部用户，2为外部用户',
  `record_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否已删除 1：正常；2：已删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `create_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
  `update_by` varchar(36) DEFAULT NULL COMMENT '最后修改人',
