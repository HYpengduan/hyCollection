...
(function (factory) {
    ...
    tPdf = '<div class="kv-preview-data file-preview-other-frame">\n' + DEFAULT_PREVIEW + '\n</div>\n';
    ...
    defaultPreviewTemplates = {
        ...
        object: tTagBef2 + tOther + tTagAft,
        pdf: tTagBef2 + tOther + tTagAft,
    ...
    defaultPreviewSettings = {
        ...
        object: {width: "40px", height: "40px"},
        pdf: {width: "40px", height: "40px"},
        other: {width: "40px", height: "40px"}
    };
    ...
    FileInput.prototype = {
        ...
        _uploadSingle: function (i, files, allFiles) {
            ...
            fnComplete = function (p1,p2) {
            	var _code = p1.responseJSON.code;
            	self.$captionContainer.children().html('')
            	if(_code===0){
            		self._setProgress(100);
            	}else{
            		self._setProgress(100,self.$progress,'失败');
            	}
                setTimeout(function () {
                    if (self.showPreview) {
