// 树结构初始化加载
//parentId
var parentIdCombo = $('#parentId').combotree({
    url: '/system/role/selectParentTreeRole',
    width:'465',
    height:'34',
    value:'0'
});
//$("#parentId span[class^='tree-icon tree-file']").remove();
...
function add() {
	...
	var parentId = parentIdCombo.combotree('getValue');
