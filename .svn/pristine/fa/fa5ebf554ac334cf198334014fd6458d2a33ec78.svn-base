package com.hy.cuis.manager.system.dept.controller;
...
import com.hy.cuis.manager.system.dept.domain.Dept;
import com.hy.cuis.manager.system.dept.service.IDeptService;
