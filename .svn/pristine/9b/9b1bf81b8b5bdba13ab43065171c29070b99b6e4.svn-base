package com.hy.cuis.manager.system.role.controller;
...
//    }
    ...
    @PostMapping("/selectParentTreeRole")
    @ResponseBody
    public List<ComboTreeNode> selectParentTreeRole(){
    	Role role = new Role();
    	this.getUser();
    	List<ComboTreeNode> rst = roleService.getTreeRole(role);
    	return rst;
    }
